...
BEGIN
{
  ...
  $postmaster        = '';
  @referers          = qw(whorld.org whorld.sourceforge.net ffrend.sourceforge.net mixere.sourceforge.net fractice.sourceforge.net waveshop.sourceforge.net chordease.sourceforge.net);
  @allow_mail_to     = qw(victimofleisure@gmail.com);
  @recipients        = ();
  %recipient_alias   = ();
